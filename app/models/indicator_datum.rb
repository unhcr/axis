class IndicatorDatum < ActiveRecord::Base
  ...
  attr_accessible :baseline, :imp_target, :comp_target, :reversal, :standard, :stored_baseline, :threshold_green, :threshold_red, :yer, :myr, :is_performance, :year, :id, :operation_id, :missing_budget

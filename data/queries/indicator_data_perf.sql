...
select obj.*
     ...
     , to_char("BI_OUTPUTGRPPERFINDICATOR".IMP_TARGET)      AS PERF_IMP_TARGET
     , to_char("BI_OUTPUTGRPPERFINDICATOR".COMP_TARGET)     AS PERF_COMP_TARGET
     , to_char("BI_OUTPUTGRPPERFINDICATOR".MID_YEAR_VALUE)  AS PERF_MID_YEAR_VALUE
     , to_char("BI_OUTPUTGRPPERFINDICATOR".YEAR_END_VALUE)  AS PERF_YEAR_END_VALUE
     , "BI_OUTPUTGRP".RFOUTPUTID
FROM obj
LEFT OUTER JOIN "BI_OUTPUTGRP"          ON "OBJID"="BI_OUTPUTGRP"."OBJECTIVEID"

...
SELECT ROUND(SUM(cost), 0) AS AMOUNT, b.OPERATIONID, b.PLANID, b.PLANNINGYEAR, b.RFGOALID, b.RFPROBLEMOBJECTIVEID, b.RFOUTPUTID, b.PPGID, b.BUDGETTYPE, b.POPGROUPTYPEID, b.BUDGETCOMPONENT
FROM bdglines b
...
GROUP BY b.OPERATIONID, b.PLANID, b.PLANNINGYEAR, b.RFGOALID, b.RFPROBLEMOBJECTIVEID, b.RFOUTPUTID, b.PPGID, b.BUDGETTYPE, b.BUDGETCOMPONENT, b.POPGROUPTYPEID

...
FROM obj
INNER JOIN "BI_OBJIMPACTINDICATOR"    ON obj.OBJID = "BI_OBJIMPACTINDICATOR".OBJECTIVE_ID
INNER JOIN "BI_IMPACTINDICATOR"  ON "BI_OBJIMPACTINDICATOR".INDICATOR_ID  = "BI_IMPACTINDICATOR"."ID"
INNER JOIN

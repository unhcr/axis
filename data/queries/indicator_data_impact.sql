...
SELECT obj.*
     ...
     , to_char("BI_OBJIMPACTINDICATOR".IMP_TARGET)      AS IMP_IMP_TARGET
     , to_char("BI_OBJIMPACTINDICATOR".COMP_TARGET)     AS IMP_COMP_TARGET
     , to_char("BI_OBJIMPACTINDICATOR".MID_YEAR_VALUE)  AS IMP_MID_YEAR_VALUE
     , to_char("BI_OBJIMPACTINDICATOR".YEAR_END_VALUE)  AS IMP_YEAR_END_VALUE
     , to_char("BI_OBJIMPACTINDICATOR".BASELINE)        AS IMP_BASELINE
     , to_char("BI_IMPACTINDICATOR".STANDARDVALUE)      AS IMP_STANDARD
     , to_char("BI_IMPACTINDICATOR".GREENVALUE)         AS IMP_GREEN
     , to_char("BI_IMPACTINDICATOR".REDVALUE)           AS IMP_RED
     , to_char("BI_IMPACTINDICATOR".ISREVERSAL)         AS IMP_ISREVERSAL
FROM obj
